...
/**
 * @fileoverview WindowManager.h
 *
 * Factory2D Window Manager Include
 *
 * @author @alexribeirodesa (Alexandre Ribeiro de Sá)
 */

#ifndef FACTORY2D_WINDOWMANAGER_WINDOWMANAGER_H_
#define FACTORY2D_WINDOWMANAGER_WINDOWMANAGER_H_
...
#endif // FACTORY2D_WINDOWMANAGER_WINDOWMANAGER_H_